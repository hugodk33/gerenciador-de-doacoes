    ...
    return (
      <section id='side-menu' className='p-1 sm:w-full md:w-3/12'>
        <ul className='flex flex-col bg-white rounded p-4 gap-2'>
            ...
            <li className='text-md uppercase'>
                <Link href="/atendimento"><MdDiversity3 className="inline-block" /> Ver atendimentos</Link>
            </li>
            <span className='text-md font-bold uppercase mt-4'>beneficiados</span>
            <hr />
            <li className='text-md uppercase'>
            ...
            <li className='text-md uppercase'>
                <Link href="/"><MdPersonSearch className="inline-block" /> Consulta de famílias e beneficiados</Link>
            </li>
            <span className='text-md font-bold uppercase mt-4'>estoque</span>
            <hr />
            <li className='text-md uppercase'>
                <Link href="/"><MdPersonAddAlt className="inline-block" /> Cadastro de produtos</Link>
            </li>
            <li className='text-md uppercase'>
                <Link href="/"><MdContentPasteSearch className="inline-block"/> Consulta de produtos</Link>
            </li>
        </ul>
      </section>
    )
