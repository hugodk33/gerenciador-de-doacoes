...
import { InputSelect, InputText, InputTextArea } from '@/components/template/input';
    ...
    <section>
      <MainCtnHorizontal>
        ...
        <div className='flex w-full pt-5 md:pl-60 md:pr-60'>
          <SideMenu />
          <Content>
            <h1 className='text-3xl pb-2 pt-2'>Pesquisar Atendimentos</h1>
            <span className="inline-block sm:w-full md:w-10/12 pt-2 pr-2" >
              <InputText label={'Digite sua busca'} />
            </span>
            ...
            <ul className="flex flex-col p-4 gap-3 rounded overflow-y-scroll mb-5 mt-5">
              <li key={'key-bottom-'} className="flex flex-row text-4xl">
                ...
                <button className="flex rounded-full justify-center bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 drop-shadow-md w-10 h-10 text-gray ml-10" >
